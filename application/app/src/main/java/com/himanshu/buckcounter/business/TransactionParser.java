...
public class TransactionParser {
    private final static String[] balanceKeywords = {
            "avbl bal",
            "available balance",
            "a/c bal",
            "available bal",
    ...
    private final static String[] trnKeywords = {
            "debited",
            "credited",
            "payment",
            "spent"
    ...
    private static String[] removeItemAll(String[] arr, String value) {
    ...
    class Account {
        ...
        public Account(String type, String no) {
            this.type = type;
            this.no = no;
        }
